...
function setConsigneeValues() {
    var value1 = $("#searchBuyer").getSelectedItemData();
//    var value = $("#searchBuyer").val;
    console.log("sgn loadData value " + value.name);
    $.ajax({
...
//            consigneeName: document.getElementById("eximBean.consigneeName").value,
        ...
        success: function (data) {
            ...
            console.log(" data.consignee_name " + JSON.stringify(data.consignee_name));
...
//            value1
            loadDetailReportData(data.consignee_name);
        }, error: function () {
