...
<html>
    <head>
        ...
        <script src="js/view/eximview.js" type="text/javascript"></script>
            ...
            <s:form class="form-horizontal"  id="myform" > 
                ...
                <div class="well">
                    ...
                    <div class="form-group">
                        <label for="usr" style="text-align: center" >Consignee Name:</label>
                        <input type="text" class="form-control" id="searchBuyer">
                    </div>
                    <!--                    <label class="control-label col-sm-3">Buyer Name </label>-->

                    <!--<input id="searchBuyer" />--> 
                    <input type="button" onclick="setConsigneeValues()" value="Search"   class="btn btn-primary btn-block"/>
                    <!--s:select
